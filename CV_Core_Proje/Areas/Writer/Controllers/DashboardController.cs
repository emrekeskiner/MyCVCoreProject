...
namespace Core_Proje.Areas.Writer.Controllers
{
    ...
    public class DashboardController : Controller
    {
        ...
        public async Task<IActionResult> UserDashboard()
        {
            ...
            string tcmbApiKey = "ApiKeyGelecek";
            string connectionKur = "https://evds2.tcmb.gov.tr/service/evds/series=TP.DK.USD.A-TP.DK.EUR.A-TP.DK.CHF.A-TP.DK.GBP.A-TP.DK.JPY.A&startDate="+ tarih.ToString("dd-MM-yyyy")+ "&endDate="+ tarih.ToString("dd-MM-yyyy") + "&type=xml&key="+tcmbApiKey;
