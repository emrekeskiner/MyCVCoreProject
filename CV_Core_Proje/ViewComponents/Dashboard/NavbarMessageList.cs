...
namespace MyCVCore.PresentationLayer.ViewComponents.Dashboard
{
    public class NavbarMessageList:ViewComponent
    {
        ...
        public NavbarMessageList(IWriterMessageService writerMessageService, UserManager<WriterUser> userManager)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var messages = _writerMessageService.GetListReceiverMessage(values.Email).OrderByDescending(x=>x.WriterMessageId).Take(3).ToList();
